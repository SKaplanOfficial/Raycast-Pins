  ...
  return (
    ...
    >
      ...
      >
        ...
        <Form.Dropdown.Item key="menubarOnly" title="Show in Menubar Only" value={Visibility.MENUBAR_ONLY.toString()} icon={Icon.Window} />
        <Form.Dropdown.Item key="raycastOnly" title="Show in 'View Pins' Only" value={Visibility.VIEW_PINS_ONLY.toString()} icon={Icon.AppWindowList} />
        <Form.Dropdown.Item key="hidden" title="Hidden" value={Visibility.HIDDEN.toString()} icon={Icon.EyeDisabled} />
        <Form.Dropdown.Item key="disabled" title="Disabled" value={Visibility.DISABLED.toString()} icon={Icon.XMarkCircle} />
      </Form.Dropdown>
